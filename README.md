...
# Recommend rooms (แนะนำ - ได้ 3 ห้อง)
curl -X POST http://localhost:9000/recommend \
  -H "Content-Type: application/json" \
  -d '{
    "department": "นิติการ",
...
API รับข้อมูล 4 features เพื่อทำนายห้องประชุมที่เหมาะสม:

#### 1️⃣ **department** (string) - แผนก/หน่วยงาน
- **คำอธิบาย:** ชื่อหน่วยงานหรือแผนกที่จองห้องประชุม
- **ตัวอย่าง:** `"สภา"`, `"นิติการ"`, `"กบศ"`, `"กบค"`, `"กนผ"`, `"คคศ"`, `"อาคาร"`, `"กพน"` เป็นต้น
- **จำนวนแผนกในระบบ:** 110 แผนก
- **หมายเหตุ:** สามารถกรอกชื่อแผนกใดก็ได้ แม้ไม่มีในข้อมูลเดิม โมเดลจะจัดการด้วย `handle_unknown="ignore"`

#### 2️⃣ **duration_hours** (number) - ระยะเวลาการใช้งาน
- **คำอธิบาย:** ระยะเวลาที่ต้องการใช้ห้องประชุม (หน่วยเป็นชั่วโมง)
- **ช่วงค่า:** 1 - 23 ชั่วโมง
- **ค่าที่พบบ่อย:** 3 ชั่วโมง (1,515 รายการ), 4 ชั่วโมง (678 รายการ), 2 ชั่วโมง (461 รายการ)
- **ค่าเฉลี่ย:** 4.04 ชั่วโมง
- **ตัวอย่าง:** `2.0`, `3.5`, `8.0`
- **ข้อกำหนด:** ต้องมากกว่าหรือเท่ากับ 0

#### 3️⃣ **event_period** (string) - ช่วงเวลาในการใช้งาน
- **คำอธิบาย:** ช่วงเวลาของวันที่ต้องการใช้ห้องประชุม
- **⚠️ ค่าที่ใช้ได้ (ภาษาอังกฤษเท่านั้น):**
  - `"Morning"` - ช่วงเช้า (1,472 รายการ)
  - `"Afternoon"` - ช่วงบ่าย (1,337 รายการ)
  - `"All Day"` - ทั้งวัน (853 รายการ)
  - `"Night"` - ช่วงค่ำ/กลางคืน (17 รายการ)
- **❌ ห้ามใช้ภาษาไทย:** `"เช้า"`, `"บ่าย"`, `"ทั้งวัน"` จะทำงานไม่ถูกต้อง

#### 4️⃣ **seats** (integer) - จำนวนที่นั่งที่ต้องการ
- **คำอธิบาย:** จำนวนคนที่ต้องการรองรับในห้องประชุม
- **ช่วงค่า:** 8 - 1,300 ที่นั่ง
- **ค่าที่พบบ่อย:** 30 ที่นั่ง (1,162 รายการ), 12 ที่นั่ง (1,001 รายการ), 8 ที่นั่ง (504 รายการ)
- **ค่าเฉลี่ย:** 126.64 ที่นั่ง
- **ตัวอย่าง:** `30`, `50`, `100`, `200`
- **ข้อกำหนด:** ต้องมากกว่าหรือเท่ากับ 1
...
response = requests.post('http://127.0.0.1:9000/recommend', json={
    'department': 'คคศ',
    'duration_hours': 3.0,
